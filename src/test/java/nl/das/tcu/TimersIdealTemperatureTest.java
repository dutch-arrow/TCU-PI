...
public class TimersIdealTemperatureTest {
	...
	public void before () throws IOException {
		...
		terrarium.setSensors(21, 26); // Ideal temperature, so temperature rules will not be activated
	}
	...
	@Test
	public void testReplaceTimer () {
		Timer[] timers = terrarium.getTimersForDevice("pump");
		assertNotNull(timers, "Timer array cannot be null");
		assertEquals(5, timers.length, "Nr of timers for pump");
