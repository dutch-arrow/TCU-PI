...
<details>
<summary>Get one of the five temperature rules</summary>

*Bluetooth*  
__Command__ : `getTemperatureRule`  
__Data__ : `{"rulenr":1}`

*REST*  
__URL__ : `GET /temperaturerule/1`  
__Data__ : None  
...
<details>
<summary>Replace a temperature rule</summary>

*Bluetooth*  
__Command__ : `saveTemperatureRule`  
__Data__ : 
<pre><code>{"rulenr":1, "rule":{
    "actions": [
        {"device": "fan_out",  "on_period": -2},
        {"device": "fan_in",   "on_period": 900},
        {"device": "sprayer",  "on_period": 50},
...
*REST*  
__URL__ : `POST /temperaturerule/1`  
__Data__ : 
<pre><code>{
    "actions": [
        {"device": "fan_out",  "on_period": -2},
